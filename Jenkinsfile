pipeline {
 ...
 bat "C:\\sonar-scanner-5.0.1.3006-windows\\bin\\sonar-scanner -Dsonar.projectKey=abdirahim1 -Dsonar.sources=src -Dsonar.host.url=http://localhost:9000 -Dsonar.login=sqa_5fcffb11490f4caaaa5e7ba6795db79e73a3691f"               
              }
            }
        }
    }
